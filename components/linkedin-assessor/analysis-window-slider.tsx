...
export function AnalysisWindowSlider({ defaultValue }: { defaultValue: number }) {
  ...
  return <div className="space-y-2 sm:col-span-2">
    ...
    <p className="text-xs leading-5 text-muted-foreground">The dashboard continuously uses the most recent {days} days. Older posts stay stored but stop affecting the current score.</p>
  </div>;
}
