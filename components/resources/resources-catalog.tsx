...
type ResourcesCatalogProps = {
  ...
  params: { category?: string; roadmap?: string; search?: string };
};

export function ResourcesCatalog({ resources, roadmaps, params }: ResourcesCatalogProps) {
  ...
  return (
    <div>
      <div className="mb-4 flex flex-wrap items-center justify-between gap-2">
        <form className="flex flex-1 flex-wrap gap-2" action={`${BASE_PATH}/tools/resources`}>
          <input
            type="search"
            name="search"
        ...
        <CreateResourceDialog roadmaps={roadmaps} />
      </div>
